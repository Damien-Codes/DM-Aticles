                  ...
                  <tbody>
                    <?php foreach($rows as $row) : ?>
                        <tr>
                          ...
                          <td><a  href="update-category.php?up_id=<?php echo $row->id; ?>" class="btn btn-warning text-white text-center ">Update</a></td>
                          <td><a href="delete-category.php?del_id=<?php echo $row->id; ?>" class="btn btn-danger  text-center ">Delete</a></td>
                        </tr>
                      <?php endforeach; ?>
                  </tbody>
              </table> 
